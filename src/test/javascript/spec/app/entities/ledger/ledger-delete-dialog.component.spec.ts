...
import { LedgerDeleteDialogComponent } from 'app/entities/ledger/ledger-delete-dialog.component';
import { LedgerService } from 'app/entities/ledger/ledger.service';

describe('Component Tests', () => {
  describe('Ledger Management Delete Component', () => {
    let comp: LedgerDeleteDialogComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [LedgerDeleteDialogComponent]
      })
        .overrideTemplate(LedgerDeleteDialogComponent, '')
        .compileComponents();
