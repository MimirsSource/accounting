...
import { RecurringTransactionComponent } from 'app/entities/recurring-transaction/recurring-transaction.component';
...
describe('Component Tests', () => {
  describe('RecurringTransaction Management Component', () => {
    let comp: RecurringTransactionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(RecurringTransactionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new RecurringTransaction(123)],
            headers
          })
        )
      );
      ...
      expect(comp.recurringTransactions && comp.recurringTransactions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
